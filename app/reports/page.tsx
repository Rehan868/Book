...
const recentReports = [
  ...
  {
    name: "Room Performance Analysis",
    date: "2024-01-14",
    type: "Rooms",
    format: "Excel",
  },
  {
    name: "Owner Payout Statement",
    date: "2024-01-13",
    type: "Owners",
    format: "PDF",
  },
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <ReportCard
              icon="🏠"
              title="Rooms Reports"
              description="Room performance, availability and maintenance status"
              link="/reports/rooms"
            />
            <ReportCard
              icon="👥"
              title="Owners Reports"
              description="Property owner statements and performance metrics"
              link="/reports/owners"
            />
            <ReportCard
              icon="🤝"
              title="Agent Reports"
              description="Travel agent and partner booking performance"
              link="/reports/agent"
            />
            <ReportCard
              icon="💰"
