...
export default function ViewBookingPage() {
  ...
  const booking = {
    ...
    paidOn: "2023-10-25",
    status: "Confirmed",
    notes: "Late check-in, around 10 PM. Would prefer a high floor with city view if possible.",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-500">Agent/Channel</p>
                        <p className="text-base">{booking.agent}</p>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-500">Number of Nights</p>
                        <p className="text-base">{booking.numberOfNights}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-base mt-1">{booking.notes}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
