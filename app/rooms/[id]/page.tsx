...
const getRoomData = (id) => {
  return {
    ...
    previousBookings: [
      { id: "B0932", guestName: "Emma Wilson", checkIn: "2024-01-05", checkOut: "2024-01-10" },
      { id: "B0875", guestName: "Michael Brown", checkIn: "2023-12-20", checkOut: "2023-12-27" },
      { id: "B0791", guestName: "Jessica Taylor", checkIn: "2023-11-15", checkOut: "2023-11-18" },
    ],
  }
}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    {room.previousBookings.length > 0 ? (
                      <div className="space-y-4">
                        {room.previousBookings.map((booking, index) => (
                          <div key={index} className="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                            <div className="flex justify-between mb-1">
                              <span className="font-medium">{booking.guestName}</span>
                              <span className="text-sm text-gray-500">#{booking.id}</span>
                      ...
                      <div className="flex flex-col items-center justify-center py-6 text-center">
                        <Calendar className="h-12 w-12 text-gray-300 mb-2" />
                        <h3 className="text-lg font-medium text-gray-900">No Previous Bookings</h3>
                        <p className="text-gray-500 mt-1">This room has no booking history.</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
